			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-9 col-lg-12 col-md-12 mx-auto">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="#" class="text-primary">Flight Listing</a></li>
							</ol>
						</nav>
					</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="row">
							<div class="col-xl-9 col-lg-8 col-md-12 mx-auto">
							
							
							
								<div class="card border-0 mb-4">
									<a href="https://ohoflights.com/contact.html">
									<div class="card-body">
										<div class="crd-block d-md-flex align-items-start justify-content-start">
											...
											<div class="crd-heaader-first ps-md-3">
												...
												<div class="d-block">
													<h4 class="mb-0">Delhi(DEL)<span class="text-muted-2 mx-3"><i class="fa-solid fa-arrow-right-arrow-left"></i></span>Kathmandu (KTM)</h4>
													<div class="explotter-info">
														<p class="detail ellipsis-container fw-semibold">
															<span class="ellipsis-item__normal">16 Jul 2024</span>
															<span class="separate ellipsis-item__normal"></span>
															<span class="ellipsis-item">One Way</span>
															<!-- <span class="separate ellipsis-item__normal"></span> -->
								...
								<a href="https://ohoflights.com/contact.html">
									<div class="card-body">
										<div class="crd-block d-md-flex align-items-start justify-content-start">
											...
											<div class="crd-heaader-first ps-md-3">
												<div class="d-inline-flex align-items-center mb-1">
													<span class="label fw-medium bg-light-success text-success">Economy Class</span>
												</div>
												<div class="d-block">
													<h4 class="mb-0">Bombay (BOM)<span class="text-muted-2 mx-3"><i class="fa-solid fa-arrow-right-arrow-left"></i></span>Sharjhah (SHJ)</h4>
													<div class="explotter-info">
														<p class="detail ellipsis-container fw-semibold">
															<span class="ellipsis-item__normal">13 June 2024</span>
															<span class="separate ellipsis-item__normal"></span>
															<span class="ellipsis-item">One Way</span>
															<!-- <span class="separate ellipsis-item__normal"></span> -->
															<!-- <span class="ellipsis-item">06H 10Min</span> -->
									...
									<div class="card-body">
										<div class="crd-block d-md-flex align-items-start justify-content-start">
											...
											<div class="crd-heaader-first ps-md-3">
												...
												<div class="d-block">
													<h4 class="mb-0">Chennai (MAA)<span class="text-muted-2 mx-3"><i class="fa-solid fa-arrow-right-arrow-left"></i></span>Colombo (CEMB)</h4>
													<div class="explotter-info">
														<p class="detail ellipsis-container fw-semibold">
															<span class="ellipsis-item__normal">16 May 2024</span>
															<span class="separate ellipsis-item__normal"></span>
															<span class="ellipsis-item">One Way</span>
															<!-- <span class="separate ellipsis-item__normal"></span> -->
															<!-- <span class="ellipsis-item">06H 10Min</span> -->
									...
									<div class="card-body">
										<div class="crd-block d-md-flex align-items-start justify-content-start">
											...
											<div class="crd-heaader-first ps-md-3">
												...
												<div class="d-block">
													<h4 class="mb-0">Delhi (DEL)<span class="text-muted-2 mx-3"><i class="fa-solid fa-arrow-right-arrow-left"></i></span>Bangalore (BLR</h4>
													<div class="explotter-info">
														<p class="detail ellipsis-container fw-semibold">
															<span class="ellipsis-item__normal">16 Jul 2024</span>
															<span class="separate ellipsis-item__normal"></span>
								...
								<a href="https://ohoflights.com/contact.html">
									<div class="card-body">
										<div class="crd-block d-md-flex align-items-start justify-content-start">
											...
											<div class="crd-heaader-first ps-md-3">
												<div class="d-inline-flex align-items-center mb-1">
													<span class="label fw-medium bg-light-success text-success">First Class</span>
												</div>
												<div class="d-block">
													<h4 class="mb-0">Pune (PNQ)<span class="text-muted-2 mx-3"><i class="fa-solid fa-arrow-right-arrow-left"></i></span>Darbhanga (DBR)</h4>
													<div class="explotter-info">
														<p class="detail ellipsis-container fw-semibold">
															<span class="ellipsis-item__normal">6 Jul 2024</span>
															<span class="separate ellipsis-item__normal"></span>
															<span class="ellipsis-item">One Way</span>
															<!-- <span class="separate ellipsis-item__normal"></span> -->
															<!-- <span class="ellipsis-item">06H 10Min</span> -->
                        ...
                        <div class="col-lg-8 col-md-8 col-12">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-6">
                                    ...
                                    <div class="footer-item">
                                        <ul>
                                            <li><a href="listing">Flight Booking</a></li>
                                            <li><a href="listing">Train Booking</a></li>
                                            <li><a href="listing">Cab Booking</a></li>
                                            <li><a href="listing">Hotel Booking</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-6">
